...
병원에 **실제로 보낸** 배포만 기록한다. 발송 4건: 2026-06-24, 2026-08-31, 2026-09-12
(사용자 확인, 2026-09-14), 2026-09-23(사용자 확인, 2026-09-23). 준비만 하고 보내지 않은 export는 넣지 않는다 —
...
| 2026-09-23 | `output/circe_be/2026-09-23/` + `tte_circe_2026-09-23.zip` | 3 (6파일) | `4de5e93` | `849dba5` (09-22 16:38 런 시작) |
...
- **2026-09-23 — 재추출본이다.** 런 디렉터리는 `output/site_gap/2026-09-22_verify5/`로 09-22 16:38에
  `849dba5`에서 시작했다. 발송 시각 HEAD `4de5e93`은 `scripts/run_fix_verification.sh`만 바꿨고 export 경로는
  건드리지 않아 내용 버전은 `849dba5`다. zip 이름은 관례(`tte_circe_3studies_arms_<날짜>.zip`)와 다른
  `tte_circe_2026-09-23.zip`로 나갔고, 나간 이름 그대로 기록했다. zip md5 `a38f574706ce824c36fdeadb1f7a2a62`.
...
| 2026-09-23 | 20/41 · 63/40/3/19 | 22/36 · 60/35/4/19 | 26/87 · 117/86/4/25 |
